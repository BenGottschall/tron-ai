...
def train():
    ...
    rl_agent1 = RLAgent(state_size=(3, 7, 7), action_size=4, player_id=1)
    rl_agent2 = RLAgent(state_size=(3, 7, 7), action_size=4, player_id=2)
    ...
    for episode in range(num_episodes):
        ...
        while not done:
            ...
            current_state2 = rl_agent1.get_state(game_board, player2, player1)
            ...
            # if episode % 50 == 0:
            #     print(f"current1 | next1 walls:\n{current_state1[2]}\n{next_state1[2]}")
            #     print(f"direction1: {player1.direction}")
            #     print(f"reward1: {reward1}")
            #     print(f"done1: {done}")
            
            
            # Remember the transitions
            rl_agent1.remember(current_state1, player1.direction, reward1, next_state1, done)
            rl_agent2.remember(current_state2, player2.direction, reward2, next_state2, done)
        ...
        if total_reward1 > high_score1:
            ...
            rl_agent1.save_model(f"tron_model_player1_checkpoint_high_score.pth")
            rl_agent2.save_model(f"tron_model_player2_checkpoint_high_score.pth")
